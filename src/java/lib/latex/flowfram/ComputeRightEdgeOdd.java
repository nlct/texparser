...
public class ComputeRightEdgeOdd extends ControlSequence
{
   public ComputeRightEdgeOdd()
   {
      this("computerightedgeodd");
   }

   public ComputeRightEdgeOdd(String name)
   {
      super(name);
   }
   ...
   public Object clone()
   {
      return new ComputeRightEdgeOdd(getName());
   }
