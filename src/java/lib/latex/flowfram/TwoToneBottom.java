...
public class TwoToneBottom extends ControlSequence
{
   public TwoToneBottom(FlowFramSty sty)
   {
      this("vtwotonebottom", true, sty);
   }

   public TwoToneBottom(String name, boolean isVertical, FlowFramSty sty)
   {
      super(name);
   ...
   public Object clone()
   {
      return new TwoToneBottom(getName(), vertical, sty);
   }
   ...
   public void process(TeXParser parser, TeXObjectList stack) throws IOException
   {
      ...
      if (vertical)
      {
         frame1 = sty.newStaticFrame(label1, 
                  false, dim1, length, offset, new UserDimension());
      ...
      else
      {
         ...
         frame2 = sty.newStaticFrame(label2, 
                  false, length, dim2, new UserDimension(), offset2);
      }
