...
public class FlowFramSetup extends ControlSequence
{
   public FlowFramSetup(FlowFramSty sty)
   {
      this("flowframsetup", sty);
   }

   public FlowFramSetup(String name, FlowFramSty sty)
   {
      super(name);
      this.sty = sty;
   }
   ...
   public Object clone()
   {
      return new FlowFramSetup(getName(), sty);
   }
