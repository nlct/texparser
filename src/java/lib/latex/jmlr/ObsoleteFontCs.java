...
public class ObsoleteFontCs extends ControlSequence
{
      ...
      throws IOException
   {
      ...
      parser.getListener().getControlSequence(obsname).process(parser, stack);
   }
      ...
      throws IOException
   {
      ...
      parser.getListener().getControlSequence(obsname).process(parser);
   }
}
