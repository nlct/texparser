...
public class GlsTableStyleSymbolOther extends ControlSequence
{
   public GlsTableStyleSymbolOther()
   {
      this("@glstable@style@symbol-other");
   }

   public GlsTableStyleSymbolOther(String name)
   {
      super(name);
   }
   ...
   public Object clone()
   {
      return new GlsTableStyleSymbolOther(getName());
   }
