...
public class GlsTableStyleDescName extends ControlSequence
{
   public GlsTableStyleDescName()
   {
      this("@glstable@style@desc-name");
   }

   public GlsTableStyleDescName(String name)
   {
      super(name);
   }
   ...
   public Object clone()
   {
      return new GlsTableStyleDescName(getName());
   }
