...
public class GlsTableStyleDescOtherSymbolName extends ControlSequence
{
   public GlsTableStyleDescOtherSymbolName()
   {
      this("@glstable@style@desc-other-symbol-name");
   }

   public GlsTableStyleDescOtherSymbolName(String name)
   {
      super(name);
   }
   ...
   public Object clone()
   {
      return new GlsTableStyleDescOtherSymbolName(getName());
   }
