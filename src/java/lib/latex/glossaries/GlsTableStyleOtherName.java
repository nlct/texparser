...
public class GlsTableStyleOtherName extends ControlSequence
{
   public GlsTableStyleOtherName()
   {
      this("@glstable@style@other-name");
   }

   public GlsTableStyleOtherName(String name)
   {
      super(name);
   }
   ...
   public Object clone()
   {
      return new GlsTableStyleOtherName(getName());
   }
