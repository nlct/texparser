...
public class GlsTableSubNameNoDesc extends AbstractGlsCommand
{
   public GlsTableSubNameNoDesc(GlossariesSty sty)
   {
      this("glstableSubNameNoDesc", sty);
   }

   public GlsTableSubNameNoDesc(String name, GlossariesSty sty)
   {
      super(name, sty);
   }
   ...
   public Object clone()
   {
      return new GlsTableSubNameNoDesc(getName(), getSty());
   }
