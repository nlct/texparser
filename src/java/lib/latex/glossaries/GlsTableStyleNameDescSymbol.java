...
public class GlsTableStyleNameDescSymbol extends ControlSequence
{
   public GlsTableStyleNameDescSymbol()
   {
      this("@glstable@style@name-desc-symbol");
   }

   public GlsTableStyleNameDescSymbol(String name)
   {
      super(name);
   }
   ...
   public Object clone()
   {
      return new GlsTableStyleNameDescSymbol(getName());
   }
     ...
     throws IOException
   {
      ...
      parser.getSettings().localSetRegister("glstablecolsperblock", UserNumber.THREE);
      ...
      def.add(new TeXCsRef("glstablesymbolwidth"));
      def.add(TeXParserUtils.createGroup(listener,
       new TeXCsRef("glstableSymbolFmt"), TeXParserUtils.createGroup(
        listener, listener.getParam(1))));
      ...
      grp.add(listener.getOther('.'));
      grp.add(listener.getOther('5'));
      grp.add(new TeXCsRef("glstablesymbolwidth"));
