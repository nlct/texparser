...
public class GlsTableStyleDescOtherName extends ControlSequence
{
   public GlsTableStyleDescOtherName()
   {
      this("@glstable@style@desc-other-name");
   }

   public GlsTableStyleDescOtherName(String name)
   {
      super(name);
   }
   ...
   public Object clone()
   {
      return new GlsTableStyleDescOtherName(getName());
   }
