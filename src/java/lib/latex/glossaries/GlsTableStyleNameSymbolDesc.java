...
public class GlsTableStyleNameSymbolDesc extends ControlSequence
{
   public GlsTableStyleNameSymbolDesc()
   {
      this("@glstable@style@name-symbol-desc");
   }

   public GlsTableStyleNameSymbolDesc(String name)
   {
      super(name);
   }
   ...
   public Object clone()
   {
      return new GlsTableStyleNameSymbolDesc(getName());
   }
