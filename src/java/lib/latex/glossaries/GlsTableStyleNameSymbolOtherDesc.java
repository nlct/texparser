...
public class GlsTableStyleNameSymbolOtherDesc extends ControlSequence
{
   public GlsTableStyleNameSymbolOtherDesc()
   {
      this("@glstable@style@name-symbol-other-desc");
   }

   public GlsTableStyleNameSymbolOtherDesc(String name)
   {
      super(name);
   }
   ...
   public Object clone()
   {
      return new GlsTableStyleNameSymbolOtherDesc(getName());
   }
