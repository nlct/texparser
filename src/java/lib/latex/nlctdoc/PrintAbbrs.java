...
public class PrintAbbrs extends AbstractGlsCommand
{
   public PrintAbbrs(GlossariesSty sty)
   {
      this("printabbrs", sty);
   }

   public PrintAbbrs(String name, GlossariesSty sty)
   {
      super(name, sty);
   }
   ...
   public Object clone()
   {
      return new PrintAbbrs(getName(), getSty());
   }
   ...
   throws IOException
   {
      ...
      if (glossary != null && !glossary.isEmpty())
      {
         ...
         list.add(listener.getControlSequence("abbreviationsname"));
         list.add(new TeXCsRef("label"));
         list.add(listener.createGroup("abbreviations"));
