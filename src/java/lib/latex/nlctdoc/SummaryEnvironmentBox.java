...
public class SummaryEnvironmentBox extends SummaryBox
{
   public SummaryEnvironmentBox(FrameBox frameBox,
      FrameBox rightBox, FrameBox noteBox, GlossariesSty sty)
   {
      this("summaryglossentryenvironment", frameBox, rightBox, noteBox, sty);
   }

   public SummaryEnvironmentBox(String name, FrameBox frameBox, 
      FrameBox rightBox, FrameBox noteBox, GlossariesSty sty)
   {
   ...
   public Object clone()
   {
      return new SummaryEnvironmentBox(getName(), frameBox, rightBox, noteBox, getSty());
   }
