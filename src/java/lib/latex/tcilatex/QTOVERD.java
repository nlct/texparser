...
public class QTOVERD extends ControlSequence
{
   public QTOVERD()
   {
      this("QTOVERD");
      ...
      throws IOException
   {
      ...
      stack.push(parser.getListener().getLetter((int)'1'));
      ...
      throws IOException
   {
      ...
      parser.push(parser.getListener().getLetter((int)'1'));
