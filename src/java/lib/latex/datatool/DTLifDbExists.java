...
public class DTLifDbExists extends ControlSequence
{
   public DTLifDbExists(DataToolSty sty)
   {
      this("DTLifdbexists", sty);
   }

   public DTLifDbExists(String name, DataToolSty sty)
   {
      super(name);
      this.sty = sty;
   }
   ...
   public Object clone()
   {
      return new DTLifDbExists(getName(), sty);
   }
     ...
     throws IOException
   {
      ...
      if (sty.dbExists(dbArg.toString(parser)))
      {
