...
public class DTLaddalign extends ControlSequence
{
   public DTLaddalign()
   {
      this("dtladdalign");
   ...
   public DTLaddalign(String name)
   {
      super(name);
   }
   ...
   public Object clone()
   {
      return new DTLaddalign(getName());
   }
     ...
     throws IOException
   {
      ...
      switch (type)
      {
         case DataToolHeader.TYPE_INT:
           tl.rightConcat((TeXObjectList)
             listener.getTokenListCommand("dtlintalign", stack).getContent().clone());
         break;
         case DataToolHeader.TYPE_REAL:
           tl.rightConcat((TeXObjectList)
             listener.getTokenListCommand("dtlrealalign", stack).getContent().clone());
         break;
         case DataToolHeader.TYPE_CURRENCY:
           tl.rightConcat((TeXObjectList)
             listener.getTokenListCommand("dtlcurrencyalign", stack).getContent().clone());
         break;
         default:
           tl.rightConcat((TeXObjectList)
             listener.getTokenListCommand("dtlstringalign", stack).getContent().clone());
      }
