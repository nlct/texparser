...
public class L2HGreekSymbol extends GreekSymbol
{
   public L2HGreekSymbol(String name, int codePoint)
   {
   ...
   public Object clone()
   {
      return new L2HGreekSymbol(getName(), getCharCode());
   }
   ...
   throws IOException
   {
      ...
      {
         // assume all GreekSymbol objects are supported by MathJax
