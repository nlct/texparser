...
public class L2HPageRef extends PageRef
{
   public L2HPageRef()
   {
      this("pageref");
      ...
      throws IOException
   {
      ...
      TeXObject ref =
         ((LaTeXParserListener)parser.getListener()).getPageReference(arg);
