...
public class GlsTableNameNoDesc extends AbstractGlsCommand
{
   public GlsTableNameNoDesc(GlossariesSty sty)
   {
      this("glstableNameNoDesc", sty);
   }

   public GlsTableNameNoDesc(String name, GlossariesSty sty)
   {
      super(name, sty);
   }
   ...
   public Object clone()
   {
      return new GlsTableNameNoDesc(getName(), getSty());
   }
