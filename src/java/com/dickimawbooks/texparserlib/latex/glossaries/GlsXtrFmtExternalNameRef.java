...
public class GlsXtrFmtExternalNameRef extends ControlSequence
{
   public GlsXtrFmtExternalNameRef()
   {
      this("glsxtrfmtexternalnameref");
   }

   public GlsXtrFmtExternalNameRef(String name)
   {
      super(name);
   }
   ...
   public Object clone()
   {
      return new GlsXtrFmtExternalNameRef(getName());
   }
     ...
     throws IOException
   {
      ...
      arg.add(listener.getControlSequence("hyperref"));
      arg.add(listener.createGroup(fileName));
      arg.add(listener.createGroup());
