...
public class GlsGetGroupTitle extends ControlSequence
{
   public GlsGetGroupTitle()
   {
      this("glsgetgrouptitle");
   }

   public GlsGetGroupTitle(String name)
   {
      super(name);
   }
   ...
   public Object clone()
   {
      return new GlsGetGroupTitle(getName());
   }
