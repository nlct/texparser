...
public class NewDGlsField extends AbstractGlsCommand
{
   public NewDGlsField(GlossariesSty sty)
   {
      this("newdglsfield", sty);
   }

   public NewDGlsField(String name, GlossariesSty sty)
   {
      super(name, sty);
   }
   ...
   public Object clone()
   {
      return new NewDGlsField(getName(), getSty());
   }
