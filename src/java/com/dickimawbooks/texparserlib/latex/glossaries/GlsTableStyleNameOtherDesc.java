...
public class GlsTableStyleNameOtherDesc extends ControlSequence
{
   public GlsTableStyleNameOtherDesc()
   {
      this("@glstable@style@name-other-desc");
   }

   public GlsTableStyleNameOtherDesc(String name)
   {
      super(name);
   }
   ...
   public Object clone()
   {
      return new GlsTableStyleNameOtherDesc(getName());
   }
     ...
     throws IOException
   {
      ...
      grp.add(listener.getOther('.'));
      grp.add(listener.getOther('5'));
      grp.add(new TeXCsRef("glstableotherwidth"));
      ...
      def.add(new TeXCsRef("glstableSubOtherPostSep"));
      def.add(TeXParserUtils.createGroup(listener, listener.getParam(1)));
