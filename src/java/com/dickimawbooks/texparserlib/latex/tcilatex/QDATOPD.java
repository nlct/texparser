...
public class QDATOPD extends ControlSequence
{
   public QDATOPD()
   {
      this("QDATOPD");
      ...
      throws IOException
   {
      ...
      stack.push(parser.getListener().getOther((int)'0'));
      ...
      throws IOException
   {
      ...
      parser.push(parser.getListener().getOther((int)'0'));
