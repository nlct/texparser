...
public class FnSym extends ControlSequence
{
   ...
   throws IOException
   {
      ...
      content.add(listener.getControlSequence("tablefnmark"));
      ...
      if (!isStar)
      {
         grp.add(listener.getControlSequence("fnsymmark"));
      ...
      grp.add(listener.getControlSequence("fnsymmarker"));
      grp.add(TeXParserUtils.createGroup(listener, arg));
