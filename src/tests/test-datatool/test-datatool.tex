...
Data
\DTLifdbexists{test2}{exists}{doesn't exist}.

\DTLnewdb{test2}
Data
\DTLifdbexists{test2}{exists}{doesn't exist}.

New row.\DTLnewrow{test2}
\DTLnewdbentry{test2}{Info}{sample}
\DTLnewdbentry{test2}{Value}{1.23}

Row count: \DTLrowcount{test2}.
Column count: \DTLcolumncount{test2}.
